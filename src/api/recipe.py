...
from core.schemas.recipe import RecipeRead, RecipeCreate, RecipeDetail
...
async def get_recipe_by_id(
    ...
    recipe = await recipe_crud.get_recipe_by_id(session=session, recipe_id=recipe_id)
    return recipe
